...
exports.setup = async function (config, isVerbose) {
    var taskList = nodemiral.taskList('Setup (linux)');
    var osName = await new Promise(function (resolve, reject) {
        taskList.execute('Check OS', {
    ...
    taskList.executeScript('Setting up Environment Variables', setupOptions);
